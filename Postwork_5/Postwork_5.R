...
#con ayuda de la función select del paquete dplyr. Luego establece un directorio de 
#trabajo y con ayuda de la función write.csv guarda el data frame como un archivo csv 
#con nombre soccer.csv. Puedes colocar como argumento row.names = FALSE en write.csv.
