                   ...
                   dashboardBody(
                       ...
                       tabItems(
                           ...
                           tabItem(tabName = "ganacias",
                                   fluidRow(
                                       column(8, align="center", offset = 2,
                                              strong( h1("Gráficas de los factores de ganancia mínimo y máximo"))),
                                       column(9, align="right", offset = 2, radioButtons("picture", "Tipo de momios:",
                                                                                         c("Escenario con momios máximos", "Escenario con momios promedio"))
